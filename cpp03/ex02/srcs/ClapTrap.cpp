...
/*   Updated: 2025/08/30 11:14:23 by ryada            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::attack(const std::string& target)
{
    ...
    std::string color = this->getColor();

    std::cout << color << this->getType() << " " << RESET 
                << this->_name
                << " attacks "
                << target
                << ", causing "
...
std::string ClapTrap::getColor() const
{
